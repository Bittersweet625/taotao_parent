package com.xidian.order.controller;
...
import com.xidian.common.utils.CookieUtils;
...
public class OrderCartController {
	...
	public String createOrder(OrderInfo orderInfo, Model model) {
		//生成订单
		TaotaoResult result = orderService.createOrder(orderInfo);//result中返回的data就是订单id
		//返回逻辑视图
